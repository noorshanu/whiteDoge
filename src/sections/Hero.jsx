  ...
  return (
    <section className=" pt-4  pb-[4rem]">
      <div className="container-wrapper">
        ...
        <div className=" py-2">
          <a
            href="https://solscan.io/token/AdAi4WRFGsc5NgyaCthV2bNmeratddFvfdDsqhMC67o3"
            target="_blank"
          ...
          >
            {" "}
            Contract : AdAi4WRFGsc5NgyaCthV2bNmeratddFvfdDsqhMC67o3
          </a>
        </div>
        ...
        <div className="relative z-40 flex items-center justify-center my-4 max-sm:flex-col max-sm:space-y-4 sm:space-x-5">
          ...
          <a
            href="https://www.dextools.io/app/en/solana/pair-explorer/HcUwrQBYPS9F62qwHwhwwjx7XNdywXriUotffn26j68h?t=1715276281157"
            target="_blank"
            className="text-base py-2 uppercase font-sushi-one px-10 rounded-xl bg-[#ffffffcf] shadow-lg shadow-black/40 text-black  font-bold  border-[#f45a7c] border-2"
          >
            DEXTOOLS
